...
export const module6Slides: Slide[] = [
  ...
  // 10 · Pays back last
  {
    ...
    sans: true,
    eyebrow: "On patience",
    headline: "Awareness pays back *last*, and pays back longest.",
    sub: "Of every foundation in this course, this one is the slowest to show a result. You will do the work and see nothing for a long while, because recognition forms quietly, below the surface, before it ever produces an enquiry. That is normal, and it is not failure. The work is invisible right up until it is not. *The silence is not the absence of progress.*",
  },
